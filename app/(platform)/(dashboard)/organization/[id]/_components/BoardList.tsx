  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 xl:grid-cols-5">
        <FormPopOver side="bottom" sideOffset={10} align="center">
          <div
            ...
            <span className="text-sm text-neutral-500"> {isPro ? "Unlimited":`${MAX_FREE_BOARDS - availableCount} remaining` } </span>
            <Hint
              description={`
